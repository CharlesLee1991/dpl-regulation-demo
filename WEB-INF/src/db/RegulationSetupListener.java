...
public class RegulationSetupListener implements ServletContextListener {
    ...
    private void createAllTables(Connection conn) throws Exception {
        ...
        // ── F3 법규 제·개정 정보용 additive 컬럼 (비파괴 — IF NOT EXISTS 가드) ──
        exec(conn, "IF NOT EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME='dpl_notify' AND COLUMN_NAME='LN_TYPE') ALTER TABLE dpl_notify ADD LN_TYPE NVARCHAR(20) DEFAULT ''");
        exec(conn, "IF NOT EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME='dpl_notify' AND COLUMN_NAME='LN_ITEM') ALTER TABLE dpl_notify ADD LN_ITEM NVARCHAR(40) DEFAULT ''");
        exec(conn, "IF NOT EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME='dpl_notify' AND COLUMN_NAME='LN_NOTI_DATE') ALTER TABLE dpl_notify ADD LN_NOTI_DATE NVARCHAR(10) DEFAULT ''");
        exec(conn, "IF NOT EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME='dpl_notify' AND COLUMN_NAME='LN_EXEC_DATE') ALTER TABLE dpl_notify ADD LN_EXEC_DATE NVARCHAR(10) DEFAULT ''");
        exec(conn, "IF NOT EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME='dpl_notify' AND COLUMN_NAME='LN_DEPT') ALTER TABLE dpl_notify ADD LN_DEPT NVARCHAR(40) DEFAULT ''");
